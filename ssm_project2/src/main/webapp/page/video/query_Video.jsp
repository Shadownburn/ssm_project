                        ...
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <c:forEach items="${videoList}" var="video">
                                <tr class="gradeX">
                                    ...
                                    <td>${video.business_info_legal_person}</td>
                                    <td class="center">${video.video_date}</td>
                                    <td class="center">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="changeVideoSrc('${video.video_src}')">查看视频</button>
                                    </td>
                                </tr>
                            </c:forEach>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <video id="videosrc" src="" controls width="500" height="300"></video>
            </div>
