        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li class="business">
                            <a class="J_menuItem" href="#">查看&编辑个人信息</a>
                        </li>
                        <li class="admin">
                            <a class="J_menuItem" href="${pageContext.request.contextPath}/ BusinessinfoController/getBusinessAll">商户列表</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="admin">
                            <a class="J_menuItem" href="${pageContext.request.contextPath}/VideoController/AqueryVideo">视频列表（管理员）</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li class="business">
                            <a class="J_menuItem" href="graph_echarts.html">音频列表</a>
                        </li>
                        <li class="business">
                            <a class="J_menuItem" href="graph_flot.html">上传音频</a>
                        </li>
                        <li class="admin">
